...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameEvents = __webpack_require__(47);
	var playerEvents = __webpack_require__(49);
	var teamEvents = __webpack_require__(51);
	var goalEvents = __webpack_require__(55);
	var assistEvents = __webpack_require__(56);
	var attendanceEvents = __webpack_require__(57);
	var postEvents = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var goalApi = __webpack_require__(41);
	var goalUi = __webpack_require__(42);
	var assistApi = __webpack_require__(44);
	var assistUi = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSetupCreateProfile = function onSetupCreateProfile() {
	  $('#create-player').html('');

	  var playerCreateListingTemplate = __webpack_require__(12);
	...
	var setTeamMembers = function setTeamMembers(data) {
	  ...
	  var playerListingTemplate = __webpack_require__(32);
	...
	var setPlayerStats = function setPlayerStats(data) {
	  ...
	  var playerCount = app.playerStats.length;
	  ...
	  app.playerStats.sort(function (a, b) {
	    return a.PPG - b.PPG;
	  }).reverse();
	...
	var showPlayersSuccess = function showPlayersSuccess(data) {
	  ...
	  var statPlayerListingTemplate = __webpack_require__(33);
	...
	module.exports = {
	  ...
	  onSetupCreateProfile: onSetupCreateProfile
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <label class=\"radio-inline\">\n        <input type=\"radio\" name=\"player[team_id]\" value="
	  ...
	  return "<!--  create player form -->\n<form id=\"create-player\">\n    <input type=\"text\" name=\"player[surname]\" placeholder=\"last name\"><br>\n    <input type=\"text\" name=\"player[given_name]\" placeholder=\"first name\"><br>\n    <input type=\"email\" id=\"create-player-email\" name=\"player[email]\" placeholder=\"email address\"><br>\n    <input type=\"text\" name=\"player[phone_number]\" placeholder=\"phone number\"><br>\n    <!-- <input type=\"text\" name=\"player[captain]\" placeholder=\"captain? yes/no\"><br> -->\n    Are you a captain?\n    <br>\n    <label class=\"radio-inline\">\n      <input type=\"radio\" name=\"player[captain]\" value=\"Yes\" />Yes\n    </label>\n    <label class=\"radio-inline\">\n      <input type=\"radio\" name=\"player[captain]\" value=\"No\" />No\n    </label>\n    <br>\n    Which team are you on?\n    <br>\n"
	    ...
	    + "    <br>\n    <input type=\"text\" class=\"hidden\" id=\"create-player-user-id\" name=\"player[user_id]\" placeholder=\"user_id\">\n    <input type=\"submit\" name=\"submit\" class=\"btn btn-default\" value=\"Create!\">\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <tr>\n      <td class=\"standings-cell person-name standings-row col-xs-1\">"
	    ...
	    + "</td>\n      <td class=\"standings-cell person-name standings-row col-xs-2\">"
	    ...
	    + "</td>\n      <td class=\"standings-cell person-name standings-row col-xs-3\">"
	  ...
	  return "<!--  team standings -->\n<table id=\"player-profile-table\" class=\"table table-striped table-bordered table-hover table-responsive players-profile-data col-xs-12\">\n  <tr>\n    <th class=\"content-cell content-header col-xs-1\">Rank</th>\n    <th class=\"content-cell content-header col-xs-2\">Surname</th>\n    <th class=\"content-cell content-header col-xs-2\">Given_name</th>\n    <th class=\"content-cell content-header col-xs-3\">Email</th>\n    <th class=\"content-cell content-header col-xs-2\">Phone_number</th>\n    <th class=\"content-cell content-header col-xs-1\">Captain</th>\n    <th class=\"content-cell content-header col-xs-1\">Team</th>\n  </tr>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <tr>\n      <td class=\"standings-cell person-name standings-row col-xs-1\">"
	    ...
	    + "</td>\n      <td class=\"standings-cell person-name standings-row col-xs-1\">"
	    + alias4(((helper = (helper = helpers.goalCount || (depth0 != null ? depth0.goalCount : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"goalCount","hash":{},"data":data}) : helper)))
	    + "</td>\n      <td class=\"standings-cell person-name standings-row col-xs-1\">"
	    + alias4(((helper = (helper = helpers.assistCount || (depth0 != null ? depth0.assistCount : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"assistCount","hash":{},"data":data}) : helper)))
	    + "</td>\n      <td class=\"standings-cell person-name standings-row col-xs-1\">"
	    + alias4(((helper = (helper = helpers.pointCount || (depth0 != null ? depth0.pointCount : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"pointCount","hash":{},"data":data}) : helper)))
	    + "</td>\n      <td class=\"standings-cell person-name standings-row col-xs-1\">"
	    + alias4(((helper = (helper = helpers.GPG || (depth0 != null ? depth0.GPG : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"GPG","hash":{},"data":data}) : helper)))
	    + "</td>\n      <td class=\"standings-cell person-name standings-row col-xs-1\">"
	    + alias4(((helper = (helper = helpers.APG || (depth0 != null ? depth0.APG : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"APG","hash":{},"data":data}) : helper)))
	    + "</td>\n      <td class=\"standings-cell person-name standings-row col-xs-1\">"
	    + alias4(((helper = (helper = helpers.PPG || (depth0 != null ? depth0.PPG : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"PPG","hash":{},"data":data}) : helper)))
	    + "</td>\n    </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<!--  player stats -->\n<table id=\"players-stats-table\" class=\"table table-striped table-bordered table-hover table-responsive players-stats-data col-xs-12\">\n  <tr>\n    <th class=\"standings-cell person-name standings-row col-xs-1\">Rank</th>\n    <th class=\"standings-cell person-name standings-row col-xs-2\">Last Name</th>\n    <th class=\"standings-cell person-name standings-row col-xs-2\">First Name</th>\n    <th class=\"standings-cell person-name standings-row col-xs-1\">Games</th>\n    <th class=\"standings-cell person-name standings-row col-xs-1\">Goals</th>\n    <th class=\"standings-cell person-name standings-row col-xs-1\">Assists</th>\n    <th class=\"standings-cell person-name standings-row col-xs-1\">Points</th>\n    <th class=\"standings-cell person-name standings-row col-xs-1\">GPG</th>\n    <th class=\"standings-cell person-name standings-row col-xs-1\">APG</th>\n    <th class=\"standings-cell person-name standings-row col-xs-1\">PPG</th>\n  </tr>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.statPlayers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</table>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showTeamsSuccess = function showTeamsSuccess(data) {
	  ...
	  var teamListingTemplate = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <tr>\n      <td class=\"standings-cell standings-row col-xs-2\" data-id="
	    ...
	    + ">"
	    + alias4(((helper = (helper = helpers.rank || (depth0 != null ? depth0.rank : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"rank","hash":{},"data":data}) : helper)))
	    + "</td>\n      <td class=\"standings-cell team-name standings-row col-xs-2\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</td>\n      <td class=\"standings-cell standings-row col-xs-2\" data-id="
	  ...
	  return "<!--  team standings -->\n<table id=\"standings-table\" class=\"table table-striped table-bordered table-hover table-responsive teams-standings col-xs-12\">\n  <tr>\n    <th class=\"standings-cell standings-header col-xs-2\">Ranking</th>\n    <th class=\"standings-cell standings-header col-xs-2\">Team</th>\n    <th class=\"standings-cell standings-header col-xs-2\">Wins</th>\n    <th class=\"standings-cell standings-header col-xs-2\">Losses</th>\n    <th class=\"standings-cell standings-header col-xs-2\">Games</th>\n    <th class=\"standings-cell standings-header col-xs-2\">Win Pct</th>\n  </tr>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.teams : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</table>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showGoalsSuccess = function showGoalsSuccess(data) {
	  $('.goals-data').html('');
	  var goalListingTemplate = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showAssistsSuccess = function showAssistsSuccess(data) {
	  $('.assists-data').html('');
	  var assistListingTemplate = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSetupGameCreation = function onSetupGameCreation(event) {
	  event.preventDefault();
	  $('#create-game').html('');

	  var createGameListingTemplate = __webpack_require__(48);
	...
	module.exports = {
	  ...
	  onSetupGameCreation: onSetupGameCreation
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <label class=\"radio-inline\">\n      <input type=\"radio\" name=\"game[opponent]\" value="
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + " checked>"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\n      <br>\n    </label>\n";
	  ...
	  return "<!--  create-game form -->\n<form id=\"create-game\">\n  <input type=\"date\" name=\"game[date]\" placeholder=\"date\"><br>\n  <!-- <input type=\"text\" name=\"game[opponent]\" placeholder=\"opponent\"><br> -->\n  Opponent?\n  <br>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.teams : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  <br>\n  <input type=\"number\" class=\"hidden\" id=\"current-team-id\" name=\"game[team_id]\" placeholder=\"team\">\n  <!-- <input type=\"text\" name=\"game[won]\" placeholder=\"won? true/false\"><br> -->\n  Won?\n  <br>\n  <label class=\"radio-inline\">\n    <input type=\"radio\" name=\"game[won]\" value=\"true\" />true\n  </label>\n  <label class=\"radio-inline\">\n    <input type=\"radio\" name=\"game[won]\" value=\"false\" />false\n  </label>\n  <br>\n  <input type=\"submit\" name=\"submit\" class=\"btn btn-default\" value=\"Create!\">\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSetupEditProfile = function onSetupEditProfile(event) {
	  event.preventDefault();
	  $('#edit-profile').html('');

	  var playerEditListingTemplate = __webpack_require__(50);
	...
	module.exports = {
	  ...
	  onSetupEditProfile: onSetupEditProfile
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var postUi = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(53);
	var helpers = __webpack_require__(9);
	...
	var showPostsSuccess = function showPostsSuccess(data) {
	  ...
	  $('.team-post-data').html('');
	  var postListingTemplate = __webpack_require__(54);
	  $('.team-post-data').html(postListingTemplate(finalSortedPosts));
	  helpers.onSetAdminRights();
	};

	var refreshPostTable = function refreshPostTable() {
	  api.show().done(showPostsSuccess).fail(failure);
	};

	var createPostSuccess = function createPostSuccess() {
	  refreshPostTable();
	};
	...
	module.exports = {
	  ...
	  showPostsSuccess: showPostsSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var destroy = function destroy(postId) {
	  return $.ajax({
	    url: app.host + '/posts/' + postId,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onShowPoints = function onShowPoints(event) {
	  ...
	  api.show().done(ui.showGoalsSuccess).fail(ui.failure);
	};

	var onDeletePoint = function onDeletePoint(event) {
	  event.preventDefault();
	  var data = $(event.target).data("id");
	  api.destroy(data).done(ui.deletePointSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateAttendance = function onCreateAttendance(event) {
	  event.preventDefault();
	  $('#createAttendanceModal').modal('hide');
	  var data = getFormFields(event.target);

	  api.create(data).done(ui.createAttendanceSuccess).fail(ui.failure);
	};

	var onDeleteAttendance = function onDeleteAttendance(event) {
	  event.preventDefault();
	  var data = $(event.target).data("id");

	  api.destroy(data).done(ui.deleteAttendanceSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var index = function index(attendanceId) {
	  return $.ajax({
	...
	var destroy = function destroy(attendanceId) {
	  return $.ajax({
	    url: app.host + '/attendances/' + attendanceId,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createAttendanceSuccess = function createAttendanceSuccess() {
	  $('#sign-in').submit();
	  $('#profile-button').click();
	};

	var deleteAttendanceSuccess = function deleteAttendanceSuccess() {
	  $('#sign-in').submit();
	  $('#profile-button').click();
	};
	...
	module.exports = {
	  success: success,
	  failure: failure,
	  createAttendanceSuccess: createAttendanceSuccess,
	  deleteAttendanceSuccess: deleteAttendanceSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreatePost = function onCreatePost(event) {
	  ...
	  api.create(data).done(ui.createPostSuccess).fail(ui.failure);
	};

	var refreshPosts = function refreshPosts() {
	  api.show().done(ui.showPostsSuccess).fail(ui.failure);
	};
